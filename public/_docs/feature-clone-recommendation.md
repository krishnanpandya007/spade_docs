...
You can clone other profiles recommendations, under some rules
* That user needs to be open at `share recommendations`
* You Must be open at `share_recommendations`
* Once you clone some other profile's recommendations, you can't turn it of for another 15 days

 ## **`Note: Recommendations are just system's predictions for user, it doesn't justify that profile's behaviour/character `**